Ext.define('Dishes.view.tablet.NewDishes', {
    extend: 'Ext.Panel',
            ...
            items: [{
                ...
                tpl: '<div style="cursor: pointer; height: 110px; padding-top: 20px; ">' +
                    ...
                    '<tpl else>' +
						...
						'<div style="color: #333; margin-left: 20px; margin-top: 10px; float: left; height: 100%; font-size: 40px;"><b>{firstname:ellipsis(15)}</b><br/><span style="color: #887251;">{lastname:ellipsis(15)}</span></div>' +
                    '</tpl>' +
                    '</div>',
                listeners: {
                    tap: {
