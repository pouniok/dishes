Ext.define('Dishes.view.tablet.Main', {
    extend: 'Ext.Panel',
	id: 'main',
    xtype: 'main',
    requires: ['Ext.Menu', 'Dishes.view.tablet.Dashboard', 'Dishes.view.tablet.NewDishes',
				'Dishes.view.tablet.Employees', 'Dishes.view.tablet.Rules'],
    ...
    config: {
		...
		listeners: {
			initialize: function(){
				...
				this.add(Ext.create('Dishes.view.tablet.Dashboard'));
				this.add(Ext.create('Dishes.view.tablet.NewDishes'));
				this.add(Ext.create('Dishes.view.tablet.Employees'));
				this.add(Ext.create('Dishes.view.tablet.Rules'));
			},
			painted: function(){
				var me = this;
