Ext.define('Dishes.view.tablet.Dashboard', {
    extend: 'Ext.Panel',
    ...
    config: {
		...
		items: [{
			...
			style: 'font-size: 20px; line-height: 40px; color: #333; text-align: center;',
			itemTpl: new Ext.XTemplate('<div style="float: left; width: 40px; font-size: 30px; color: #DDD;">{rank}</div>' +
					'<div style="float: left; width: 60px; font-size: 30px;">{icon}</div>' +
					...
					'</span></tpl></div>' +
					'<div style="float: left; width: 200px; text-align: left;"><b>{firstname}</b> <span style="color:#887251;">{lastname}</span></div>' +
					'<div style="float: left; width: 70px;">{couverts} <i style="color: #DDD;" class="fa fa-cutlery" aria-hidden="true"></i></div>' +
					'<div style="float: left; width: 70px;">{boites} <i style="color: #DDD;" class="fa fa-archive" aria-hidden="true"></i></div>' +
					'<div style="float: left; width: 70px;">{cafes} <i style="color: #DDD;" class="fa fa-coffee" aria-hidden="true"></i></div>' +
					'<div style="float: left; width: 70px;">{verres} <i style="color: #DDD;" class="fa fa-glass" aria-hidden="true"></i></div>' +
					'<div style="float: left; width: 90px;">{presence}% <i style="color: #DDD;" class="fa fa-users" aria-hidden="true"></i></div>' +
					'<div style="float: right; width: 70px; font-size: 30px;">'+
						'<tpl if="values.rank == 1"><span style="width: 60px; height: 60px; position: absolute; right: 20px; top: 10px;" class="fa-stack">' +
							'<i style="color: #887251; font-size: 60px;" class="fa fa-certificate fa-stack-1x"></i>' +
							'<i style="font-size: 26px; color: #EEE;" class="fa-stack-1x">{note_pondere}</i>' +
						'</span>'+
						'<tpl else><span style="font-size: 26px; color: #887251;">{note_pondere}</span>'+
						'</tpl>'+
					'</div>')
  		}]
    }
