Ext.define('Dishes.view.phone.Main', {
    extend: 'Ext.Panel',
	id: 'main',
    xtype: 'main',
    requires: ['Ext.Menu', 'Dishes.view.phone.Dashboard', 'Dishes.view.phone.NewDishes', 
				'Dishes.view.phone.Employees', 'Dishes.view.phone.Rules'],
    ...
    config: { 
		...
		listeners: {
			initialize: function(){
				...
				this.add(Ext.create('Dishes.view.phone.Dashboard'));
				this.add(Ext.create('Dishes.view.phone.NewDishes'));
				this.add(Ext.create('Dishes.view.phone.Employees'));
				this.add(Ext.create('Dishes.view.phone.Rules'));
			},
			painted: function(){
				var me = this;
